<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingManagement.aspx.cs" Inherits="hrms.netragenix.Web.UI.TrainingManagement" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-chart"></i><span>Training</span> </a></li>
