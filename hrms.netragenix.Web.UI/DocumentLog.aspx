<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentLog.aspx.cs" Inherits="hrms.netragenix.Web.UI.DocumentLog" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="DocumentManagement.aspx" class="menu-toggle"><i class="zmdi zmdi-lock"></i><span>Documents</span> </a></li>
		</ul>
	</div>
	<!-- #Menu --> 
</aside>
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtDocumentName" name="txtDocumentName" Placeholder="Document Name" runat="server" required="required" />
                                    <%--<asp:RegularExpressionValidator runat="server" ID="regDocumentName" ControlToValidate="txtDocumentName" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Special Characters not allowed" ValidationExpression="^[\sa-zA-Z0-9]*$">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlDocumentType" Enabled ="true" required="required">
                                        <asp:ListItem Value="">-- Please Select Document Type --</asp:ListItem>
                                        <asp:ListItem Value="Word">Word</asp:ListItem>
                                        <asp:ListItem Value="Excel">Excel</asp:ListItem>
                                        <asp:ListItem Value="Excel">PDF</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtUploadedDate" name="txtUploadedDate" Placeholder="Uploaded Date" runat="server" required="required" />
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:FileUpload ID="fuUploadFiles" runat="server" />
                                <%--<p>
                            ...
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Log Documents" OnClick="btnSubmit_Click"></asp:Button>
                            <asp:Label ID="lblDocumentNameValidation" runat="server" ></asp:Label>
                        </form>
                    </div>
                </div>
            </div>
