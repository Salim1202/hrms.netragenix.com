<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkforceManagement.aspx.cs" Inherits="hrms.netragenix.Web.UI.WorkforceManagement" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-delicious"></i><span>Workforce</span></a></li>
