<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentLog.aspx.cs" Inherits="hrms.netragenix.Web.UI.RecruitmentLog" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="RecruitmentManagement.aspx" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Recruitment</span> </a></li>
...
<section class="content">    
    <div class="container-fluid">
        <div class="block-header">
            <h2>Log Recruitment</h2>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="BusinessDeskManagement.aspx">Home</a></li>			
                <li class="breadcrumb-item active">Log Recruitment</li>
            </ul>
        </div>  
        <!-- Basic Validation -->
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtCandidateName" name="txtCandidateName" Placeholder="Candidate Name" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtInterviewDate" name="txtInterviewDate" runat="server" required="required" />
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtConfirmationDate" name="txtConfirmationDate" runat="server" required="required" />
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlTakenBy" Enabled ="true" required="required">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Log Recruitment" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
