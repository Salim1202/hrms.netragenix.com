<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkforceUpdate.aspx.cs" Inherits="hrms.netragenix.Web.UI.WorkforceUpdate" %>
    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Update Workforce</li>
            </ul>
        </div>  
        <!-- Basic Validation -->
                ...
                <div class="card">
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtDateOfBirth" name="txtDateOfBirth" Placeholder="Date of Birth" runat="server" required="required" />
                                </div>
                                <div class="help-info">YYYY-MM-DD format</div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtJoiningDate" name="txtJoiningDate" Placeholder="Date of Joining" runat="server" required="required" />
                                </div>
                                <div class="help-info">YYYY-MM-DD format</div>
                            </div>
                            <div class="form-group form-float">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:FileUpload id="fucProfileImage" runat="server" required="required" />
                            ...
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Update Workforce Information" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
