...
{
    public partial class PerformanceManagement : System.Web.UI.Page
    {
        ...
        {
            return performanceBL.GetPerformanceDetails(authentication.usertype, authentication.employeeid);
        }
        ...
        public string getGridMenu()
        {
            ...
            if (authentication.usertype == "Administrator")
            {
                ...
                CommonString += "<li><a href='PerformanceLog.aspx'>Log Performance</a></li>";
                CommonString += "</ul>";
                CommonString += "</li>";
                CommonString += "</ul>";
            }
