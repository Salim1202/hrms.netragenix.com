<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskCreate.aspx.cs" Inherits="hrms.netragenix.Web.UI.TaskCreate" %>
                ...
                <div class="card">
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtTaskName" name="txtTaskName" Placeholder="Task Name" runat="server" required="required" />
                                </div>
                            </div>
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Save Task" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
