<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformanceManagement.aspx.cs" Inherits="hrms.netragenix.Web.UI.PerformanceManagement" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-image"></i><span>Performance</span> </a></li>
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more-vert"></i> </a>
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="PerformanceLog.aspx">Log Performance</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
