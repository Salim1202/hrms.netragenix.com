<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="PayrollManagement.aspx.cs" Inherits="hrms.netragenix.Web.UI.PayrollManagement" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-home"></i><span>Business Desk</span></a></li>
			...
			<li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Payroll</span></a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <%--<form runat="server">
                            <asp:Button ID="btnPDFDownload" runat="server" Text="Download as PDF" OnClick="btnPDFDownload_Click" />                            
                        </form>--%>
                        <form runat="server">
                                <asp:Button ID="btnGenerateCrystalReport" runat="server" Text="Generate Salary Report" OnClick="btnGenerateCrystalReport_Click" />
                                <cr:crystalreportviewer runat="server" autodatabind="True"  ID="SalarySlipViewer" Visible="false" Height="1202px" ReportSourceID="MainReport" ToolPanelWidth="200px" Width="1104px"></cr:crystalreportviewer>
                                <CR:CrystalReportSource ID="MainReport" runat="server">
                                    <Report FileName="MainReport.rpt" >
                                    </Report>
                            ...
                            <asp:DropDownList ID="ddlMonth" runat="server">                                
                                ...
                                <asp:ListItem>12</asp:ListItem>
                                                                        ...
                                                                        <%--DataSourceID="SqlDataSource1" DataTextField="employeecode" DataValueField="employeeid"--%>
                            <asp:DropDownList ID="ddlEmployeeCode" runat="server" Visible="false">
                                </asp:DropDownList>
                                <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hrms.netragenixConnectionString %>" SelectCommand="SELECT [employeeid], [employeecode] FROM [Employee]"></asp:SqlDataSource>--%>
                        </form>
