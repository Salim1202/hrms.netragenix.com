...
{
    public partial class TrainingManagement : System.Web.UI.Page
    {
        ...
        {
            return trainingBL.GetTrainingDetails(authentication.usertype, authentication.employeeid);
        }
        ...
        public string getGridMenu()
        {
            ...
            if (authentication.usertype == "Administrator")
            {
                ...
                CommonString += "<li><a href='TrainingLog.aspx'>Log Training</a></li>";
                CommonString += "</ul>";
                CommonString += "</li>";
                CommonString += "</ul>";
            }
