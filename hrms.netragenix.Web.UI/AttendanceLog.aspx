<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendanceLog.aspx.cs" Inherits="hrms.netragenix.Web.UI.AttendanceLog" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="AttendanceManagement.aspx" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Attendance</span></a></li>
    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Log Attendance</li>
            </ul>
        </div>  
        <!-- Basic Validation -->
                ...
                <div class="card">
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:Label class="form-control" id="lblLogDate" Text="" Placeholder="Log Date" runat="server" />
                                </div>
                                <div class="help-info">YYYY-MM-DD format</div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtAction" name="txtAction" Placeholder="Present/Absent" runat="server" required="required" />
                                </div>
                            </div>
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Log Attendance" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
