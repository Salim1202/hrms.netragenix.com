<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingLog.aspx.cs" Inherits="hrms.netragenix.Web.UI.TrainingLog" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="TrainingManagement.aspx" class="menu-toggle"><i class="zmdi zmdi-chart"></i><span>Training</span> </a></li>
    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Log Training</li>
            </ul>
        </div>  
        <!-- Basic Validation -->
                ...
                <div class="card">
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtTrainingDate" name="txtTrainingDate" Placeholder="Training Date" runat="server" required="required" />
                                </div>
                                <div class="help-info">YYYY-MM-DD format</div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtScheduleDate" name="txtScheduleDate" Placeholder="Schedule Date" runat="server" required="required" />
                                </div>
                                <div class="help-info">YYYY-MM-DD format</div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtParticulars" name="txtParticulars" Placeholder="Particulars" runat="server" required="required" />
                                </div>
                            </div>
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Log Training" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
