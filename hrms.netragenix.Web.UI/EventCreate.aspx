<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventCreate.aspx.cs" Inherits="hrms.netragenix.Web.UI.EventCreate" %>
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtEventName" name="txtEventName" Placeholder="Event Name" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtEventDescription" name="txtEventDescription" Placeholder="Event Description" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtScheduledOn" name="txtScheduledOn" Placeholder="Scheduled On" runat="server" required="required" />
                                </div>
                                <div class="help-info">YYYY-MM-DD format</div>
                            </div>
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Save Event" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
