<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="WorkforceCreate.aspx.cs" Inherits="hrms.netragenix.Web.UI.WorkforceCreate" %>
...
<section class="content">    
    <div class="container-fluid">
        <div class="block-header">
            <h2>Create Workforce</h2>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="BusinessDeskManagement.aspx">Home</a></li>			
                <li class="breadcrumb-item active">Create Workforce</li>
            </ul>
        </div>  
        <!-- Basic Validation -->
                    ...
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtEmployeeCode" name="txtEmployeeCode" Placeholder="Employee Code" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtFirstName" name="txtFirstName" Placeholder="First Name" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtLastName" name="txtLastName" Placeholder="Last Name" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtDateOfBirth" name="txtDateOfBirth" runat="server" required="required" />
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtJoiningDate" name="txtJoiningDate" runat="server" required="required" />
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtMobile" name="txtMobile" Placeholder="Mobile" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtEmail" name="txtEmail" Placeholder="Email" runat="server" required="required" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlGender" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlMaritalStatus" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlEmployeeType" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlDepartment" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlPosition" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlUserType" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <textarea rows="1" class="form-control no-resize auto-growth" id="txtAddress" Placeholder="Address" runat="server" required="required"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlStatus" Enabled ="true" required="required">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlActive" Enabled ="true" required="required">
                            ...
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Save Workforce Information" OnClick="btnSubmit_Click"></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
