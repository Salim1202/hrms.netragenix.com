<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecruitmentManagement.aspx.cs" Inherits="hrms.netragenix.Web.UI.RecruitmentManagement" %>
...
<aside id="leftsidebar" class="sidebar"> 
	...
	<div class="menu">
		<ul class="list">
			...
			<li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-swap-alt"></i><span>Recruitment</span> </a></li>
