<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayrollLog.aspx.cs" Inherits="hrms.netragenix.Web.UI.PayrollLog" %>
    ...
    <div class="container-fluid">
        <div class="block-header">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Log Payroll</li>
            </ul>
        </div>  
        <!-- Basic Validation -->
                ...
                <div class="card">
                    <div class="body">
                        <form id="form_validation" method="POST" runat="server" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtGrossSalary" name="txtGrossSalary" Placeholder="Gross Salary" runat="server" required="required" />
                                </div>                                
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:TextBox class="form-control" id="txtNetSalary" name="txtNetSalary" Placeholder="Net Salary" runat="server" required="required" />
                                </div>                                
                            </div>
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <asp:DropDownList class="form-control show-tick" runat="server" id="ddlStatus" Enabled ="true" required="required">
                                        <asp:ListItem Selected="True" Value="0" Text="Pending"> </asp:ListItem>
                            
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <asp:Button ID="btnSubmit" class="btn btn-raised btn-primary waves-effect" runat="server" CausesValidation="false" Text="Log Payroll" OnClick="btnSubmit_Click" ></asp:Button>
                        </form>
                    </div>
                </div>
            </div>
