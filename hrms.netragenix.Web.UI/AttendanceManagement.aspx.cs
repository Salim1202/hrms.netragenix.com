...
namespace hrms.netragenix.Web.UI
{
    public partial class AttendanceManagement : System.Web.UI.Page
    {
        ...
        {
            return attendanceBL.GetAttendanceDetails(authentication.usertype, authentication.employeeid);
        }
        ...
        public string getGridMenu()
        {
            ...
            if (authentication.usertype == "Administrator")
            {
                ...
                CommonString += "<li><a href='AttendanceLog.aspx'>Log Attendance</a></li>";
                CommonString += "</ul>";
                CommonString += "</li>";
                CommonString += "</ul>";
            }
