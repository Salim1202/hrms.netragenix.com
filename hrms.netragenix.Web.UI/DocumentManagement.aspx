<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentManagement.aspx.cs" Inherits="hrms.netragenix.Web.UI.DocumentManagement" %>
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <%--<th><asp:LinkButton ID="lbFilesupload" runat="server" OnClick="lbFilesupload_Click">Files Uploaded</asp:LinkButton></th>--%>
                                        <th>Uploaded File</th>
                                    </tr>
                                </thead>
                                <tbody>
